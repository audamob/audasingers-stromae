...
import com.audamob.audasingers.model.Tweet;
...
public class TweetsAdapter extends BaseAdapter {
	...
	public TweetsAdapter(Activity activity, ArrayList<Tweet> tweets) {
		...
		this.rAvatar = new RoundedAvatarDrawable(
				BitmapFactory.decodeResource(activity.getResources(), R.drawable.auda_singer_tweet));
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.auda_item_tweet, null);
