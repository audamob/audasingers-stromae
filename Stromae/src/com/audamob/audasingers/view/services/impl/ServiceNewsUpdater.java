...
import com.LiL.Wayne.Activity.activity.Home;
...
public class ServiceNewsUpdater extends Service implements IServiceDataUpdater<News> {
		...
		private void fetch_VH1_Tuner(String title, String date,String description, String url, String writer, String imageUrl) {
		 ...
		 public void News_Notification(String writer, String date, String content,int id){
		    	...
		    	if(id==0){
		    		contentView.setImageViewResource(R.id.imagewriter, R.drawable.mtvnews_c);
		    	}else if(id==1){
		    		contentView.setImageViewResource(R.id.imagewriter, R.drawable.mtvbuzzworthy_c);
		    	}else{
		    		contentView.setImageViewResource(R.id.imagewriter, R.drawable.vh1tuner_c);
		    	}
